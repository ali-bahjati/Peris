...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Sat Aug 25 14:17:58 2012
...
SOURCES       = ./main.cpp \
		...
		./scale.cpp \
		./linepoints.cpp \
		./smooth.cpp moc_drawingform.cpp \
		moc_drawingarea.cpp
OBJECTS       = main.o \
		drawingform.o \
		drawingarea.o \
...
smooth.o: ./smooth.cpp ./smooth.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o smooth.o ./smooth.cpp
